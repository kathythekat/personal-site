...
function Home() {
  ...
  return (
    <div className="h-screen d-flex flex-col items-center justify-center">
      <div 
        className="lg:h-1/2 mt-10 mb-6 lg:my-20 flex flex-col lg:flex-row justify-center items-center">
        <img
        ...
        <button 
        ref={animateRef}
        className="text-green-500 bg-transparent border border-solid border-green-500 hover:bg-green-400 hover:text-white active:bg-blue-600 font-bold text-md mt-4 px-6 py-3 rounded-lg outline-none focus:outline-none mr-2 mb-1 ease-linear transition-all duration-500 animate-wiggle" 
        type="button"
